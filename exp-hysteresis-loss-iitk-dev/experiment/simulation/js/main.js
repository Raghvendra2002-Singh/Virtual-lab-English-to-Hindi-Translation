...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function completeConnections() {
      ...
      alert("कनेक्शन पूरे हो गए। अब प्रतिरोध समायोजित करें और सिमुलेशन शुरू करें।");
  }
  ...
  startButton.addEventListener("click", function () {
      if (resultsTableBody.rows.length > 0) {
          ...
          alert("सिमुलेशन शुरू करने से पहले परिणाम उत्पन्न करने के लिए प्रतिरोध स्लाइडर को समायोजित करें।");
      }
  });
